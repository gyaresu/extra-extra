(function (root, factory) {
    ...
    // pages/zerg.jade compiled template
    templatizer["pages"]["zerg"] = function tmpl_pages_zerg() {
        return '<section class="page zerg"><h2>A test of epic proportions</h2><p>Wooble.</p></section>';
    };
